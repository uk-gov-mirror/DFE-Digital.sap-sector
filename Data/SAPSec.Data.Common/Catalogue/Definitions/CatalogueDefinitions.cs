...
{
    public static IReadOnlyList<string> Types { get; } = [Ks4Performance.Type, Ks4Destinations.Type, PupilAbsence.Type];

    public static IReadOnlyList<MeasureSet> MeasureSets() => [.. Ks4Performance.MeasureSets(), .. Ks4Destinations.MeasureSets(), .. PupilAbsence.MeasureSets()];
