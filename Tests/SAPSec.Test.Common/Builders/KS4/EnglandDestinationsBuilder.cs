...
public class EnglandDestinationsBuilder()
{
    ...
    public EnglandDestinations Build() =>
        ...
        {
            Id = "National",
            AllDest_Tot_Eng_Current_Pct = MeasureValue.Parse(AllDest_Tot_Eng_Current_Pct),
            AllDest_Tot_Eng_Previous_Pct = MeasureValue.Parse(AllDest_Tot_Eng_Previous_Pct),
            AllDest_Tot_Eng_Previous2_Pct = MeasureValue.Parse(AllDest_Tot_Eng_Previous2_Pct),
            Education_Tot_Eng_Current_Pct = MeasureValue.Parse(Education_Tot_Eng_Current_Pct),
            Education_Tot_Eng_Previous_Pct = MeasureValue.Parse(Education_Tot_Eng_Previous_Pct),
            Education_Tot_Eng_Previous2_Pct = MeasureValue.Parse(Education_Tot_Eng_Previous2_Pct),
            Apprentice_Tot_Eng_Current_Pct = MeasureValue.Parse(Apprentice_Tot_Eng_Current_Pct),
            Apprentice_Tot_Eng_Previous_Pct = MeasureValue.Parse(Apprentice_Tot_Eng_Previous_Pct),
            Apprentice_Tot_Eng_Previous2_Pct = MeasureValue.Parse(Apprentice_Tot_Eng_Previous2_Pct),
            Employment_Tot_Eng_Current_Pct = MeasureValue.Parse(Employment_Tot_Eng_Current_Pct),
            Employment_Tot_Eng_Previous_Pct = MeasureValue.Parse(Employment_Tot_Eng_Previous_Pct),
            Employment_Tot_Eng_Previous2_Pct = MeasureValue.Parse(Employment_Tot_Eng_Previous2_Pct),
        };
}
