...
public class LAPerformanceBuilder(string laId)
{
    ...
    public LAPerformance Build() =>
        ...
        {
            Id = laId,
            RwmExpected_Tot_Cohort_LA_Current_Num = MeasureValue.Parse(RwmExpected_Tot_Cohort_LA_Current_Num),
            RwmExpected_Tot_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmExpected_Tot_Cohort_LA_Previous_Num),
            RwmExpected_Tot_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmExpected_Tot_Cohort_LA_Previous2_Num),
            RwmExpected_Reading_Tot_Cohort_LA_Current_Num = MeasureValue.Parse(RwmExpected_Reading_Tot_Cohort_LA_Current_Num),
            RwmExpected_Reading_Tot_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmExpected_Reading_Tot_Cohort_LA_Previous_Num),
            RwmExpected_Reading_Tot_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmExpected_Reading_Tot_Cohort_LA_Previous2_Num),
            RwmExpected_Writing_Tot_Cohort_LA_Current_Num = MeasureValue.Parse(RwmExpected_Writing_Tot_Cohort_LA_Current_Num),
            RwmExpected_Writing_Tot_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmExpected_Writing_Tot_Cohort_LA_Previous_Num),
            RwmExpected_Writing_Tot_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmExpected_Writing_Tot_Cohort_LA_Previous2_Num),
            RwmExpected_Maths_Tot_Cohort_LA_Current_Num = MeasureValue.Parse(RwmExpected_Maths_Tot_Cohort_LA_Current_Num),
            RwmExpected_Maths_Tot_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmExpected_Maths_Tot_Cohort_LA_Previous_Num),
            RwmExpected_Maths_Tot_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmExpected_Maths_Tot_Cohort_LA_Previous2_Num),
            RwmHigher_Tot_Cohort_LA_Current_Num = MeasureValue.Parse(RwmHigher_Tot_Cohort_LA_Current_Num),
            RwmHigher_Tot_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmHigher_Tot_Cohort_LA_Previous_Num),
            RwmHigher_Tot_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmHigher_Tot_Cohort_LA_Previous2_Num),
            RwmHigher_Reading_Tot_Cohort_LA_Current_Num = MeasureValue.Parse(RwmHigher_Reading_Tot_Cohort_LA_Current_Num),
            RwmHigher_Reading_Tot_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmHigher_Reading_Tot_Cohort_LA_Previous_Num),
            RwmHigher_Reading_Tot_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmHigher_Reading_Tot_Cohort_LA_Previous2_Num),
            RwmHigher_Writing_Tot_Cohort_LA_Current_Num = MeasureValue.Parse(RwmHigher_Writing_Tot_Cohort_LA_Current_Num),
            RwmHigher_Writing_Tot_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmHigher_Writing_Tot_Cohort_LA_Previous_Num),
            RwmHigher_Writing_Tot_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmHigher_Writing_Tot_Cohort_LA_Previous2_Num),
            RwmHigher_Maths_Tot_Cohort_LA_Current_Num = MeasureValue.Parse(RwmHigher_Maths_Tot_Cohort_LA_Current_Num),
            RwmHigher_Maths_Tot_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmHigher_Maths_Tot_Cohort_LA_Previous_Num),
            RwmHigher_Maths_Tot_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmHigher_Maths_Tot_Cohort_LA_Previous2_Num),
            ReadingScaledScore_Tot_Cohort_LA_Current_Num = MeasureValue.Parse(ReadingScaledScore_Tot_Cohort_LA_Current_Num),
            ReadingScaledScore_Tot_Cohort_LA_Previous_Num = MeasureValue.Parse(ReadingScaledScore_Tot_Cohort_LA_Previous_Num),
            ReadingScaledScore_Tot_Cohort_LA_Previous2_Num = MeasureValue.Parse(ReadingScaledScore_Tot_Cohort_LA_Previous2_Num),
            MathsScaledScore_Tot_Cohort_LA_Current_Num = MeasureValue.Parse(MathsScaledScore_Tot_Cohort_LA_Current_Num),
            MathsScaledScore_Tot_Cohort_LA_Previous_Num = MeasureValue.Parse(MathsScaledScore_Tot_Cohort_LA_Previous_Num),
            MathsScaledScore_Tot_Cohort_LA_Previous2_Num = MeasureValue.Parse(MathsScaledScore_Tot_Cohort_LA_Previous2_Num),
            GpsExpected_Tot_Cohort_LA_Current_Num = MeasureValue.Parse(GpsExpected_Tot_Cohort_LA_Current_Num),
            GpsExpected_Tot_Cohort_LA_Previous_Num = MeasureValue.Parse(GpsExpected_Tot_Cohort_LA_Previous_Num),
            GpsExpected_Tot_Cohort_LA_Previous2_Num = MeasureValue.Parse(GpsExpected_Tot_Cohort_LA_Previous2_Num),
            GpsHigher_Tot_Cohort_LA_Current_Num = MeasureValue.Parse(GpsHigher_Tot_Cohort_LA_Current_Num),
            GpsHigher_Tot_Cohort_LA_Previous_Num = MeasureValue.Parse(GpsHigher_Tot_Cohort_LA_Previous_Num),
            GpsHigher_Tot_Cohort_LA_Previous2_Num = MeasureValue.Parse(GpsHigher_Tot_Cohort_LA_Previous2_Num),
            RwmExpected_Boy_Cohort_LA_Current_Num = MeasureValue.Parse(RwmExpected_Boy_Cohort_LA_Current_Num),
            RwmExpected_Boy_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmExpected_Boy_Cohort_LA_Previous_Num),
            RwmExpected_Boy_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmExpected_Boy_Cohort_LA_Previous2_Num),
            RwmExpected_Grl_Cohort_LA_Current_Num = MeasureValue.Parse(RwmExpected_Grl_Cohort_LA_Current_Num),
            RwmExpected_Grl_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmExpected_Grl_Cohort_LA_Previous_Num),
            RwmExpected_Grl_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmExpected_Grl_Cohort_LA_Previous2_Num),
            RwmExpected_Dis_Cohort_LA_Current_Num = MeasureValue.Parse(RwmExpected_Dis_Cohort_LA_Current_Num),
            RwmExpected_Dis_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmExpected_Dis_Cohort_LA_Previous_Num),
            RwmExpected_Dis_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmExpected_Dis_Cohort_LA_Previous2_Num),
            RwmExpected_NDi_Cohort_LA_Current_Num = MeasureValue.Parse(RwmExpected_NDi_Cohort_LA_Current_Num),
            RwmExpected_NDi_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmExpected_NDi_Cohort_LA_Previous_Num),
            RwmExpected_NDi_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmExpected_NDi_Cohort_LA_Previous2_Num),
            RwmExpected_EAL_Cohort_LA_Current_Num = MeasureValue.Parse(RwmExpected_EAL_Cohort_LA_Current_Num),
            RwmExpected_EAL_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmExpected_EAL_Cohort_LA_Previous_Num),
            RwmExpected_EAL_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmExpected_EAL_Cohort_LA_Previous2_Num),
            RwmExpected_Writing_Dis_Cohort_LA_Current_Num = MeasureValue.Parse(RwmExpected_Writing_Dis_Cohort_LA_Current_Num),
            RwmExpected_Writing_Dis_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmExpected_Writing_Dis_Cohort_LA_Previous_Num),
            RwmExpected_Writing_Dis_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmExpected_Writing_Dis_Cohort_LA_Previous2_Num),
            RwmHigher_Boy_Cohort_LA_Current_Num = MeasureValue.Parse(RwmHigher_Boy_Cohort_LA_Current_Num),
            RwmHigher_Boy_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmHigher_Boy_Cohort_LA_Previous_Num),
            RwmHigher_Boy_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmHigher_Boy_Cohort_LA_Previous2_Num),
            RwmHigher_Grl_Cohort_LA_Current_Num = MeasureValue.Parse(RwmHigher_Grl_Cohort_LA_Current_Num),
            RwmHigher_Grl_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmHigher_Grl_Cohort_LA_Previous_Num),
            RwmHigher_Grl_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmHigher_Grl_Cohort_LA_Previous2_Num),
            RwmHigher_Dis_Cohort_LA_Current_Num = MeasureValue.Parse(RwmHigher_Dis_Cohort_LA_Current_Num),
            RwmHigher_Dis_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmHigher_Dis_Cohort_LA_Previous_Num),
            RwmHigher_Dis_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmHigher_Dis_Cohort_LA_Previous2_Num),
            RwmHigher_NDi_Cohort_LA_Current_Num = MeasureValue.Parse(RwmHigher_NDi_Cohort_LA_Current_Num),
            RwmHigher_NDi_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmHigher_NDi_Cohort_LA_Previous_Num),
            RwmHigher_NDi_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmHigher_NDi_Cohort_LA_Previous2_Num),
            RwmHigher_EAL_Cohort_LA_Current_Num = MeasureValue.Parse(RwmHigher_EAL_Cohort_LA_Current_Num),
            RwmHigher_EAL_Cohort_LA_Previous_Num = MeasureValue.Parse(RwmHigher_EAL_Cohort_LA_Previous_Num),
            RwmHigher_EAL_Cohort_LA_Previous2_Num = MeasureValue.Parse(RwmHigher_EAL_Cohort_LA_Previous2_Num),
            GpsExpected_Boy_Cohort_LA_Current_Num = MeasureValue.Parse(GpsExpected_Boy_Cohort_LA_Current_Num),
            GpsExpected_Boy_Cohort_LA_Previous_Num = MeasureValue.Parse(GpsExpected_Boy_Cohort_LA_Previous_Num),
            GpsExpected_Boy_Cohort_LA_Previous2_Num = MeasureValue.Parse(GpsExpected_Boy_Cohort_LA_Previous2_Num),
            GpsExpected_Grl_Cohort_LA_Current_Num = MeasureValue.Parse(GpsExpected_Grl_Cohort_LA_Current_Num),
            GpsExpected_Grl_Cohort_LA_Previous_Num = MeasureValue.Parse(GpsExpected_Grl_Cohort_LA_Previous_Num),
            GpsExpected_Grl_Cohort_LA_Previous2_Num = MeasureValue.Parse(GpsExpected_Grl_Cohort_LA_Previous2_Num),
            GpsExpected_Dis_Cohort_LA_Current_Num = MeasureValue.Parse(GpsExpected_Dis_Cohort_LA_Current_Num),
            GpsExpected_Dis_Cohort_LA_Previous_Num = MeasureValue.Parse(GpsExpected_Dis_Cohort_LA_Previous_Num),
            GpsExpected_Dis_Cohort_LA_Previous2_Num = MeasureValue.Parse(GpsExpected_Dis_Cohort_LA_Previous2_Num),
            GpsExpected_NDi_Cohort_LA_Current_Num = MeasureValue.Parse(GpsExpected_NDi_Cohort_LA_Current_Num),
            GpsExpected_NDi_Cohort_LA_Previous_Num = MeasureValue.Parse(GpsExpected_NDi_Cohort_LA_Previous_Num),
            GpsExpected_NDi_Cohort_LA_Previous2_Num = MeasureValue.Parse(GpsExpected_NDi_Cohort_LA_Previous2_Num),
            GpsExpected_EAL_Cohort_LA_Current_Num = MeasureValue.Parse(GpsExpected_EAL_Cohort_LA_Current_Num),
            GpsExpected_EAL_Cohort_LA_Previous_Num = MeasureValue.Parse(GpsExpected_EAL_Cohort_LA_Previous_Num),
            GpsExpected_EAL_Cohort_LA_Previous2_Num = MeasureValue.Parse(GpsExpected_EAL_Cohort_LA_Previous2_Num),
            GpsHigher_Boy_Cohort_LA_Current_Num = MeasureValue.Parse(GpsHigher_Boy_Cohort_LA_Current_Num),
            GpsHigher_Boy_Cohort_LA_Previous_Num = MeasureValue.Parse(GpsHigher_Boy_Cohort_LA_Previous_Num),
            GpsHigher_Boy_Cohort_LA_Previous2_Num = MeasureValue.Parse(GpsHigher_Boy_Cohort_LA_Previous2_Num),
            GpsHigher_Grl_Cohort_LA_Current_Num = MeasureValue.Parse(GpsHigher_Grl_Cohort_LA_Current_Num),
            GpsHigher_Grl_Cohort_LA_Previous_Num = MeasureValue.Parse(GpsHigher_Grl_Cohort_LA_Previous_Num),
            GpsHigher_Grl_Cohort_LA_Previous2_Num = MeasureValue.Parse(GpsHigher_Grl_Cohort_LA_Previous2_Num),
            GpsHigher_Dis_Cohort_LA_Current_Num = MeasureValue.Parse(GpsHigher_Dis_Cohort_LA_Current_Num),
            GpsHigher_Dis_Cohort_LA_Previous_Num = MeasureValue.Parse(GpsHigher_Dis_Cohort_LA_Previous_Num),
            GpsHigher_Dis_Cohort_LA_Previous2_Num = MeasureValue.Parse(GpsHigher_Dis_Cohort_LA_Previous2_Num),
            GpsHigher_NDi_Cohort_LA_Current_Num = MeasureValue.Parse(GpsHigher_NDi_Cohort_LA_Current_Num),
            GpsHigher_NDi_Cohort_LA_Previous_Num = MeasureValue.Parse(GpsHigher_NDi_Cohort_LA_Previous_Num),
            GpsHigher_NDi_Cohort_LA_Previous2_Num = MeasureValue.Parse(GpsHigher_NDi_Cohort_LA_Previous2_Num),
            GpsHigher_EAL_Cohort_LA_Current_Num = MeasureValue.Parse(GpsHigher_EAL_Cohort_LA_Current_Num),
            GpsHigher_EAL_Cohort_LA_Previous_Num = MeasureValue.Parse(GpsHigher_EAL_Cohort_LA_Previous_Num),
            GpsHigher_EAL_Cohort_LA_Previous2_Num = MeasureValue.Parse(GpsHigher_EAL_Cohort_LA_Previous2_Num),
            ReadingScaledScore_Boy_Cohort_LA_Current_Num = MeasureValue.Parse(ReadingScaledScore_Boy_Cohort_LA_Current_Num),
            ReadingScaledScore_Boy_Cohort_LA_Previous_Num = MeasureValue.Parse(ReadingScaledScore_Boy_Cohort_LA_Previous_Num),
            ReadingScaledScore_Boy_Cohort_LA_Previous2_Num = MeasureValue.Parse(ReadingScaledScore_Boy_Cohort_LA_Previous2_Num),
            ReadingScaledScore_Grl_Cohort_LA_Current_Num = MeasureValue.Parse(ReadingScaledScore_Grl_Cohort_LA_Current_Num),
            ReadingScaledScore_Grl_Cohort_LA_Previous_Num = MeasureValue.Parse(ReadingScaledScore_Grl_Cohort_LA_Previous_Num),
            ReadingScaledScore_Grl_Cohort_LA_Previous2_Num = MeasureValue.Parse(ReadingScaledScore_Grl_Cohort_LA_Previous2_Num),
            ReadingScaledScore_Dis_Cohort_LA_Current_Num = MeasureValue.Parse(ReadingScaledScore_Dis_Cohort_LA_Current_Num),
            ReadingScaledScore_Dis_Cohort_LA_Previous_Num = MeasureValue.Parse(ReadingScaledScore_Dis_Cohort_LA_Previous_Num),
            ReadingScaledScore_Dis_Cohort_LA_Previous2_Num = MeasureValue.Parse(ReadingScaledScore_Dis_Cohort_LA_Previous2_Num),
            ReadingScaledScore_NDi_Cohort_LA_Current_Num = MeasureValue.Parse(ReadingScaledScore_NDi_Cohort_LA_Current_Num),
            ReadingScaledScore_NDi_Cohort_LA_Previous_Num = MeasureValue.Parse(ReadingScaledScore_NDi_Cohort_LA_Previous_Num),
            ReadingScaledScore_NDi_Cohort_LA_Previous2_Num = MeasureValue.Parse(ReadingScaledScore_NDi_Cohort_LA_Previous2_Num),
            ReadingScaledScore_EAL_Cohort_LA_Current_Num = MeasureValue.Parse(ReadingScaledScore_EAL_Cohort_LA_Current_Num),
            ReadingScaledScore_EAL_Cohort_LA_Previous_Num = MeasureValue.Parse(ReadingScaledScore_EAL_Cohort_LA_Previous_Num),
            ReadingScaledScore_EAL_Cohort_LA_Previous2_Num = MeasureValue.Parse(ReadingScaledScore_EAL_Cohort_LA_Previous2_Num),
            MathsScaledScore_Boy_Cohort_LA_Current_Num = MeasureValue.Parse(MathsScaledScore_Boy_Cohort_LA_Current_Num),
            MathsScaledScore_Boy_Cohort_LA_Previous_Num = MeasureValue.Parse(MathsScaledScore_Boy_Cohort_LA_Previous_Num),
            MathsScaledScore_Boy_Cohort_LA_Previous2_Num = MeasureValue.Parse(MathsScaledScore_Boy_Cohort_LA_Previous2_Num),
            MathsScaledScore_Grl_Cohort_LA_Current_Num = MeasureValue.Parse(MathsScaledScore_Grl_Cohort_LA_Current_Num),
            MathsScaledScore_Grl_Cohort_LA_Previous_Num = MeasureValue.Parse(MathsScaledScore_Grl_Cohort_LA_Previous_Num),
            MathsScaledScore_Grl_Cohort_LA_Previous2_Num = MeasureValue.Parse(MathsScaledScore_Grl_Cohort_LA_Previous2_Num),
            MathsScaledScore_Dis_Cohort_LA_Current_Num = MeasureValue.Parse(MathsScaledScore_Dis_Cohort_LA_Current_Num),
            MathsScaledScore_Dis_Cohort_LA_Previous_Num = MeasureValue.Parse(MathsScaledScore_Dis_Cohort_LA_Previous_Num),
            MathsScaledScore_Dis_Cohort_LA_Previous2_Num = MeasureValue.Parse(MathsScaledScore_Dis_Cohort_LA_Previous2_Num),
            MathsScaledScore_NDi_Cohort_LA_Current_Num = MeasureValue.Parse(MathsScaledScore_NDi_Cohort_LA_Current_Num),
            MathsScaledScore_NDi_Cohort_LA_Previous_Num = MeasureValue.Parse(MathsScaledScore_NDi_Cohort_LA_Previous_Num),
            MathsScaledScore_NDi_Cohort_LA_Previous2_Num = MeasureValue.Parse(MathsScaledScore_NDi_Cohort_LA_Previous2_Num),
            MathsScaledScore_EAL_Cohort_LA_Current_Num = MeasureValue.Parse(MathsScaledScore_EAL_Cohort_LA_Current_Num),
            MathsScaledScore_EAL_Cohort_LA_Previous_Num = MeasureValue.Parse(MathsScaledScore_EAL_Cohort_LA_Previous_Num),
            MathsScaledScore_EAL_Cohort_LA_Previous2_Num = MeasureValue.Parse(MathsScaledScore_EAL_Cohort_LA_Previous2_Num),
        };
}
